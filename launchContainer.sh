...
sudo docker run -it -v $CONF_DIR:/program/config_jsons -v $HTML_DIR:/program/html -v $OUTP_DIR:/program/output -p $OUT_PORT:80 --rm watermark python /program/main.py 
